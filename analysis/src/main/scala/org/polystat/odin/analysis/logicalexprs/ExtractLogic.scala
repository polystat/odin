...
object ExtractLogic {
  ...
  def checkImplication(methodBefore: LMethod, methodAfter: LMethod): EitherNel[String, String] = {
    import smtlib.theories.Core._
    val declarations = (methodBefore.declarations("") ++ methodAfter.declarations("")).distinct
