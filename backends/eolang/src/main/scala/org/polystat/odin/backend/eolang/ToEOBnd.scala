...
abstract class ToEOBnd[T, R, NR](implicit
  toEO: ToEO[T, R],
  eoRepr: EOBndRepr[R, NR]
) {
...
object ToEOBnd {
  ...
  def apply[T, R, NR](implicit toEOBnd: ToEOBnd[T, R, NR]): ToEOBnd[T, R, NR] =
    toEOBnd

  object ops {

    def bndToEO[T, R, NR](src: T)(name: NR)(implicit
      toEOBnd: ToEOBnd[T, R, NR]
    ): R =
  ...
  object instances {
    ...
    implicit def stringBndString[T](implicit
      toEO: ToEO[T, String],
      eoRepr: EOBndRepr[String, String]
    ): ToEOBnd[T, String, String] =
      new ToEOBnd[T, String, String] {}

    implicit def inlineOrLinesBndString[T](implicit
      toEO: ToEO[T, InlineOrLines],
