...
object Parser {
  ...
  private[parser] def program[_: P](indent: Int, indentationStep: Int): P[EOProg[EOExprOnly]] = P(
    Start ~/
      metas ~/
  ...
  private[parser] def `object`[_: P](indent: Int, indentationStep: Int): P[EOBnd[EOExprOnly]] = P(
